...
// half the field (325.8415) - blue x value + half the field (325.8415) = red x value
  ...
  */
  ...
  public void robotPeriodic() {
    SmartDashboard.putNumber("x odometry",DrivetrainSubsystem.m_pose.getX() / TICKS_PER_METER);
    SmartDashboard.putNumber("y odometry",DrivetrainSubsystem.m_pose.getY()/ TICKS_PER_METER);

...
public class PneumaticIntakeSubsystem {
    ...
    String colorString;
    public PneumaticIntakeStates pneumaticIntakeState = PneumaticIntakeStates.ACTUATING;

    public static final double COLOR_THRESHOLD = 0.03; //air pressure?
    //confirm we are using double solenoid
    private DoubleSolenoid solenoidOne = new DoubleSolenoid(2, PneumaticsModuleType.REVPH, 8, 10); //solenoid is valve that lets air through

...
public class OI {
    ...
    public static Button intakeOn = Button.kA; //need to be coded for triggers rather than buttons
    public static Button intakeOff = Button.kX; // need to figure out code for triggers
    //public static Button outtake = Button. - need a to change intake to triggers so we can use buttons for outtake
